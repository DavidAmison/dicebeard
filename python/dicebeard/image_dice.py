...
class Dice:
    ...
    def mode_pic(self, roll_out, total):
        ...
        if dice_rolled < 3:
            ...
            out_img_size = [100*dice_rolled,150] #extra 50 for total
        else:
            out_img_size = [500,100*int((dice_rolled-1)/5)+150] #extra 50 for total
    
        #Create the image to be output
        out_img = Image.new('RGBA', out_img_size)
        
        #determine whether coins or dice and convert the rolls into pictures based on input request and roll result
